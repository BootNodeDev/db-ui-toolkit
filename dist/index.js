...
`,ir=Ht.div.attrs((({className:e="dbuitkDropdownButton"})=>({className:e})))`
  ...
  user-select: none;
  width: 100%;
`,ar=e=>{var{button:t,className:r,direction:o="downwards",disabled:i=!1,highlightItem:a,items:u,position:M="left"}=e,c=function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(r[o[i]]=e[o[i]])}return r}(e,["button","className","direction","disabled","highlightItem","items","position"]);const l=n.default.useMemo((()=>{const e="number"==typeof a,t=e&&a<0,r=Array.isArray(u)&&e&&a>u.length-1;if(!t&&!r)return a}),[a,u]),[s,L]=(0,n.useState)(!1),[j,N]=(0,n.useState)(l),g=(0,n.createRef)(),d=(0,n.useCallback)((e=>{e.stopPropagation(),i||L(!s)}),[i,s]);(0,n.useEffect)((()=>{const e=e=>{g&&g.current&&g.current.contains(e.target)||L(!1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[g]);const y=(e,t)=>{const{$closeOnClick:r=!0,onClick:o,className:i}=e.props;return(0,n.cloneElement)(e,{className:`${i||""} ${void 0!==l&&t===j?"dropdownItemActive":""}`.trim(),onClick:e=>{e.stopPropagation(),r&&L(!1),N(t),o&&o()}})};return n.default.createElement(or,Object.assign({className:`${s?"isOpen":""} ${r||""}`.trim(),disabled:i,ref:g},c),n.default.createElement(ir,{className:(s?"isActive":"").trim(),onClick:d},t),n.default.createElement(tr,{as:Array.isArray(u)?rr:void 0,$direction:o,$position:M,$isOpen:s},Array.isArray(u)?u.map(((e,t)=>y(e,t))):y(u)))},ur=$t`
  ${({$status:e})=>"error"===e?$t`
...
`,vr=e=>{var{$onClose:t,$closeOnOutsideClick:r=!0}=e,o=Ar(e,["$onClose","$closeOnOutsideClick"]);const i=(0,n.useRef)(null),a=()=>{i.current&&i.current.close()},u=()=>{a(),null==t||t()};return(0,n.useEffect)((()=>(i.current&&i.current.showModal(),()=>{a()})),[]),n.default.createElement(Er,{onClick:e=>{i.current&&e.target===i.current&&r&&u()},ref:i},n.default.createElement(Or,Object.assign({},o)),n.default.createElement(br,{onClick:u}))},wr=Ht.header`
...
`;const Yr=Ht.img.attrs((({alt:e="Logo"})=>({alt:e})))`
  ...
  display: block;
  flex-shrink: 0;
`,Qr=e=>{var t=function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(r[o[i]]=e[o[i]])}return r}(e,[]);return n.default.createElement(Yr,Object.assign({},t))};const Ur=Ht.svg`
  display: block;
  flex-shrink: 0;
...
`;Vr.defaultProps={className:"dark"};const $r=Ht.svg`
  display: block;
  flex-shrink: 0;
...
`;$r.defaultProps={className:"light"};const Br=Ht.div`
  background-color: transparent;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Xr=Ht.button.attrs((({type:e="button"})=>({type:e})))`
...
`,to=e=>{var{onClick:t}=e,r=function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(r[o[i]]=e[o[i]])}return r}(e,["onClick"]);return n.default.createElement(Xr,Object.assign({onClick:t},r),n.default.createElement(Hr,null,n.default.createElement(eo,null)),n.default.createElement(Fr,null,n.default.createElement(Kr,null)),n.default.createElement(Jr,null))},ro=Ht.p`
...
`,Mo=$t`
  ...
  ${Dr("desktopWideStart",$t`
    ...
    `)}
`;var co=i.YM,lo=i.$n,so=i.Ql,Lo=i.hE,jo=i.Zp,No=i.Ve,go=i.i8,yo=i._8,Io=i.ms,So=i.Gr,fo=i.wi,Do=i.$g,xo=i.d3,To=i.Y9,po=i.wO,zo=i.q7,ho=i.tN,Co=i.gu,mo=i.pq,Ao=i.gZ,Eo=i.y$,Oo=i.IG,bo=i.EY,vo=i.qT,wo=i.TX,ko=i.cc,Yo=i.A1,Qo=i.y8,Uo=i.mO,Po=i.g,Zo=i.fi;export{co as ActiveButtonCSS,lo as Button,so as ButtonCSS,Lo as ButtonVariantCSS,jo as Card,No as ContainerPadding,go as CopyButton,yo as DisabledButtonCSS,Io as Dropdown,So as ExternalLink,fo as Footer,Do as GeneralError,xo as GeneralErrorDialog,To as Header,po as InnerContainer,zo as Item,ho as Items,Co as Logo,mo as LogoMini,Ao as Main,Eo as Spinner,Oo as SwitchThemeButton,bo as Text,vo as Textfield,wo as TextfieldCSS,ko as ThemedButton,Yo as Title,Qo as Toast,Uo as Wrapper,Po as breakpointMediaQuery,Zo as breakpoints};