...
`,ir=Ht.div.attrs((({className:e="dbuitkDropdownButton"})=>({className:e})))`
  ...
  user-select: none;
  width: 100%;
`,ar=e=>{var{button:t,className:r,clearDropdownStyle:o=!1,direction:i="downwards",disabled:a=!1,highlightItem:u,items:M,position:c="left"}=e,l=function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(o=Object.getOwnPropertySymbols(e);i<o.length;i++)t.indexOf(o[i])<0&&Object.prototype.propertyIsEnumerable.call(e,o[i])&&(r[o[i]]=e[o[i]])}return r}(e,["button","className","clearDropdownStyle","direction","disabled","highlightItem","items","position"]);const s=n.default.useMemo((()=>{const e="number"==typeof u,t=e&&u<0,r=Array.isArray(M)&&e&&u>M.length-1;if(!t&&!r)return u}),[u,M]),[L,j]=(0,n.useState)(!1),[N,d]=(0,n.useState)(s),g=(0,n.createRef)(),y=(0,n.useCallback)((e=>{e.stopPropagation(),a||j(!L)}),[a,L]);(0,n.useEffect)((()=>{const e=e=>{g&&g.current&&g.current.contains(e.target)||j(!1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[g]);const I=(e,t)=>{const{$closeOnClick:r=!0,onClick:o,className:i}=e.props;return(0,n.cloneElement)(e,{className:`${i||""} ${void 0!==s&&t===N?"dropdownItemActive":""}`.trim(),onClick:e=>{e.stopPropagation(),r&&j(!1),d(t),o&&o()}})};return n.default.createElement(or,Object.assign({className:`${L?"isOpen":""} ${r||""}`.trim(),disabled:a,ref:g},l),n.default.createElement(ir,{onClick:y},t),n.default.createElement(tr,{as:o?void 0:rr,$direction:i,$position:c,$isOpen:L},Array.isArray(M)?M.map(((e,t)=>I(e,t))):I(M)))},ur=$t`
  ${({$status:e})=>"error"===e?$t`
...
`,Ir=e=>{var{children:t=n.default.createElement(gr,null),target:r="_blank"}=e,o=dr(e,["children","target"]);return n.default.createElement(yr,Object.assign({target:r},o),t)},Sr=Ht.footer`
  align-items: center;
...
`,Mo=$t`
  ...
  ${Dr("desktopWideStart",$t`
    ...
    `)}
`;var co=i.YM,lo=i.$n,so=i.Ql,Lo=i.hE,jo=i.Zp,No=i.Ve,go=i.i8,yo=i._8,Io=i.ms,So=i.Gr,fo=i.wi,Do=i.$g,xo=i.d3,To=i.Y9,po=i.wO,zo=i.q7,ho=i.gu,Co=i.pq,mo=i.gZ,Ao=i.y$,Eo=i.IG,Oo=i.EY,bo=i.qT,vo=i.TX,wo=i.cc,ko=i.A1,Yo=i.y8,Qo=i.mO,Uo=i.g,Po=i.fi;export{co as ActiveButtonCSS,lo as Button,so as ButtonCSS,Lo as ButtonVariantCSS,jo as Card,No as ContainerPadding,go as CopyButton,yo as DisabledButtonCSS,Io as Dropdown,So as ExternalLink,fo as Footer,Do as GeneralError,xo as GeneralErrorDialog,To as Header,po as InnerContainer,zo as Item,ho as Logo,Co as LogoMini,mo as Main,Ao as Spinner,Eo as SwitchThemeButton,Oo as Text,bo as Textfield,vo as TextfieldCSS,wo as ThemedButton,ko as Title,Yo as Toast,Qo as Wrapper,Uo as breakpointMediaQuery,Po as breakpoints};