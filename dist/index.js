...
`,lr=t=>{var{children:e=o.default.createElement(sr,null),target:r="_blank"}=t,M=jr(t,["children","target"]);return o.default.createElement(Nr,Object.assign({target:r},M),e)},gr=He.footer`
  align-items: center;
...
`,zr=t=>{var{actionButton:e,icon:r=o.default.createElement(Sr,null),message:M="Something went wrong.",title:u="Error"}=t,i=dr(t,["actionButton","icon","message","title"]);return o.default.createElement(Dr,Object.assign({},i),o.default.createElement(Tr,null,r),o.default.createElement(xr,null,u),o.default.createElement(pr,null,M),e)},fr=He.header`
...
`;br.defaultProps={className:"dark"};const vr=He.svg`
  display: block;
  flex-shrink: 0;
...
`,Ur=He.button.attrs((({type:t="button"})=>({type:t})))`
...
`,Pr=He.div`
  ...
  width: var(--base-switch-theme-button-active-state-size);
  z-index: 1;
`,Zr=(function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];var M=qt(Be.apply(void 0,n([t],e,!1))),u=wt(M);return new me(u,M)})`
  from {
...
`,Vr=t=>{var{onClick:e}=t,r=function(t,e){var r={};for(var M in t)Object.prototype.hasOwnProperty.call(t,M)&&e.indexOf(M)<0&&(r[M]=t[M]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var u=0;for(M=Object.getOwnPropertySymbols(t);u<M.length;u++)e.indexOf(M[u])<0&&Object.prototype.propertyIsEnumerable.call(t,M[u])&&(r[M[u]]=t[M[u]])}return r}(t,["onClick"]);return o.default.createElement(Ur,Object.assign({onClick:e},r),o.default.createElement(Qr,null,o.default.createElement(Wr,null)),o.default.createElement(Yr,null,o.default.createElement(Rr,null)),o.default.createElement(Pr,null))},Br=He.p`
...
`,_r=Be`
  ...
  ${Ir("desktopWideStart",Be`
    ...
    `)}
`;var qr=u.YM,Kr=u.$n,tM=u.Ql,eM=u.hE,rM=u.Zp,MM=u.Ve,uM=u.i8,iM=u._8,nM=u.ms,oM=u.Gr,aM=u.wi,cM=u.$g,LM=u.Y9,jM=u.wO,sM=u.q7,NM=u.gu,lM=u.pq,gM=u.gZ,yM=u.IG,IM=u.EY,dM=u.cc,SM=u.A1,DM=u.y8,TM=u.mO,xM=u.g,pM=u.fi;export{qr as ActiveButtonCSS,Kr as Button,tM as ButtonCSS,eM as ButtonVariantCSS,rM as Card,MM as ContainerPadding,uM as CopyButton,iM as DisabledButtonCSS,nM as Dropdown,oM as ExternalLink,aM as Footer,cM as GeneralError,LM as Header,jM as InnerContainer,sM as Item,NM as Logo,lM as LogoMini,gM as Main,yM as SwitchThemeButton,IM as Text,dM as ThemedButton,SM as Title,DM as Toast,TM as Wrapper,xM as breakpointMediaQuery,pM as breakpoints};