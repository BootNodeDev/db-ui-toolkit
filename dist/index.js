...
`,fr=e=>{var{children:t=u.default.createElement(yr,null),target:r="_blank"}=e,o=gr(e,["children","target"]);return u.default.createElement(Ir,Object.assign({target:r},o),t)},pr=Ht.footer`
  align-items: center;
...
`,br=e=>{var{actionButton:t,icon:r=u.default.createElement(Tr,null),message:o="Something went wrong.",title:a="Error"}=e,i=Dr(e,["actionButton","icon","message","title"]);return u.default.createElement(Cr,Object.assign({},i),u.default.createElement(hr,null,r),u.default.createElement(mr,null,a),u.default.createElement(zr,null,o),t)};var Ar=function(e,t){var r={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(r[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var a=0;for(o=Object.getOwnPropertySymbols(e);a<o.length;a++)t.indexOf(o[a])<0&&Object.prototype.propertyIsEnumerable.call(e,o[a])&&(r[o[a]]=e[o[a]])}return r};const Er=Ht.dialog`
  border: none;
  border-radius: var(--base-border-radius, 8px);
  padding: 0;
`,Or=Ht(br)`
...
`,No=()=>{const e=(0,u.useRef)(null),[t,r]=(0,u.useState)(!1),[o,a]=(0,u.useState)(null),i=(0,u.useCallback)((e=>{a(e),r(!0)}),[]),n=(0,u.useCallback)((()=>{a(null),r(!1)}),[]);return(0,u.useEffect)((()=>{e.current&&t&&e.current.showModal(),e.current&&!t&&e.current.close()}),[t]),{open:i,close:n,Dialog:({closeOnOutsideClick:r=!0,closeOnEscape:a=!0})=>u.default.createElement(jo,{onCancel:e=>{e.preventDefault(),a&&n()},onClick:r?t=>{e.current&&t.target===e.current&&r&&n()}:void 0,onKeyDown:e=>{e.preventDefault(),"Escape"===e.key&&a&&n()},ref:e},t?o:null)}},go=$t`
  ...
  ${xr("desktopWideStart",$t`
    ...
    `)}
`;var yo=a.YM,Io=a.$n,fo=a.Ql,po=a.hE,So=a.Zp,xo=a.Ve,Do=a.i8,To=a._8,Co=a.ms,ho=a.Gr,mo=a.wi,zo=a.$g,bo=a.d3,Ao=a.Y9,Eo=a.wO,Oo=a.q7,vo=a.tN,wo=a.gu,ko=a.pq,Yo=a.gZ,Qo=a.aF,Uo=a.y$,Po=a.IG,Zo=a.EY,Go=a.qT,Ro=a.TX,Wo=a.cc,Vo=a.A1,$o=a.y8,Bo=a.mO,Fo=a.g,Ho=a.fi,Xo=a.sp;export{yo as ActiveButtonCSS,Io as Button,fo as ButtonCSS,po as ButtonVariantCSS,So as Card,xo as ContainerPadding,Do as CopyButton,To as DisabledButtonCSS,Co as Dropdown,ho as ExternalLink,mo as Footer,zo as GeneralError,bo as GeneralErrorDialog,Ao as Header,Eo as InnerContainer,Oo as Item,vo as Items,wo as Logo,ko as LogoMini,Yo as Main,Qo as Modal,Uo as Spinner,Po as SwitchThemeButton,Zo as Text,Go as Textfield,Ro as TextfieldCSS,Wo as ThemedButton,Vo as Title,$o as Toast,Bo as Wrapper,Fo as breakpointMediaQuery,Ho as breakpoints,Xo as useDialog};