...
type ModalProps = HTMLAttributes<HTMLDialogElement> & PropsWithChildren
...
const useModal = ({ closeOnOutsideClick = true }: Options = {}): Props => {
  ...
  const Modal: FC<ModalProps> = ({ children }) => {
    ...
    return (
      <Dialog onClick={closeOnOutsideClick ? handleOutsideClick : undefined} ref={dialogRef}>
        {isOpen && children}
